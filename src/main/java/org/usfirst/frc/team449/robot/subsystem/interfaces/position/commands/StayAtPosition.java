...
/**
 * Go to a given position and stay there.
 */
@JsonIdentityInfo(generator = ObjectIdGenerators.StringIdGenerator.class)
public class StayAtPosition<T extends Subsystem & SubsystemPosition> extends Command {
     ...
     */
    @JsonCreator
    public StayAtPosition(@NotNull @JsonProperty(required = true) T subsystem,
