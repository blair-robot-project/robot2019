...
public class GoToTargetWPI<T extends Subsystem & SubsystemMPTwoSides & SubsystemAHRS> extends CommandGroup {
     ...
     */
    @JsonCreator
    public GoToTargetWPI(@NotNull @JsonProperty(required = true) T subsystem,
    ...
    private double getX() {
        ...
        return table.getEntry("camtran").getDoubleArray(new double[] {0, 0, 0, 0, 0, 0})[0] + xOffset;
    }
    ...
    private double getY() {
        //Not a typo, this is how our coordinate transform works
        return table.getEntry("camtran").getDoubleArray(new double[] {0, 0, 0, 0, 0, 0})[1] + yOffset;
